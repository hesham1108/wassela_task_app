...
extension WidgetExtension on Widget? {
  ...
  /// return align to start
  Align toStart() {
    return Align(alignment: AlignmentDirectional.centerStart, child: this);
  }
...
extension DateTimeExtension on DateTime {
  /// Returns the full month name based on the current app locale
  ...
  String fullDateName(BuildContext context) {
    return '$day ${monthName(context)} $year';
  }

  String dayMonth(BuildContext context) {
    return '$day ${monthName(context)}';
  }

  //add format for "2026-01-01T07:00:00" to display date and time in format "fullDateName  07:00 AM"
  String fullDateNameWithTime(BuildContext context) {
    return '${fullDateName(context)} ${hour < 12 ? hour : hour - 12}:${minute < 10 ? '0' : ''}$minute ${hour < 12 ? 'AM' : 'PM'}';
  }
  // 07:00 AM
  String timeOnly() {
    return '${hour < 12 ? hour : hour - 12}:${minute < 10 ? '0' : ''}$minute ${hour < 12 ? 'AM' : 'PM'}';
  }
  String getDayPeriod() {
